  ...
  return (
      <Layout>
        <div className={style.indexCard}>
          <h3 className={style.Title}>{days[this.state.day]}, {months[this.state.month]} {this.state.date}, {this.state.year} {this.state.time}</h3>
          <h4 className={style.Title}>{this.state.header}</h4>
          <p className={style.body}>{this.state.description}</p>
          <h3 className={style.clockface}>Countdown: <DateCountdown dateTo={this.state.launchTime} /> </h3>
        ...
        <div className={style.indexCard}>
          ...
          <h3 className={style.clockface}>Countdown: <DateCountdown dateTo={this.state.launchTime1} /> </h3>
          <div className={style.imageContainer}>
          <img
              className={style.rocketImg}
              src={image1}
        ...
        <div className={style.indexCard}>
          ...
          <h3 className={style.clockface}>Countdown: <DateCountdown dateTo={this.state.launchTime2} /> </h3>
          <div className={style.imageContainer}>
          <img
              className={style.rocketImg}
              src={image2}
